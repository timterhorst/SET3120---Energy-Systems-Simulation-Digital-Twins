...
def load_configurations(
    ...
    non_init_configs = {'controller_config.yaml', 'ev_config.yaml'}
    ...
    for config_file in config_files:
        if config_file == 'controller_config.yaml':
            ...
            continue
        if config_file in non_init_configs:
            continue
        ...
        with open(config_path, 'r') as file:
            ...
            if use_forecasted:
                init_settings = config_data.setdefault("InitializationSettings", {})
                init_settings["passive_consumers_power_setpoints"] = "data/combined_active_power_forecasted.csv"
